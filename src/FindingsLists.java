...
public class FindingsLists {
    public FindingsLists() throws InterruptedException {
        ...
        hashMap<String , String> fossilDirectory = new HashMao<>();
        System.out.println("Fossil data downloaded");

        fossilDirectory.put("Bird Fossil" , "The fossil has wings implying it was capable or flight");
        fossilDirectory.put("Fish Fossil" , "I think it swam, yo");
